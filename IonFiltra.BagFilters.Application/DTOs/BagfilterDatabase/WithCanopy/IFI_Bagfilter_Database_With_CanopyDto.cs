namespace IonFiltra.BagFilters.Application.DTOs.BagfilterDatabase.WithCanopy
{
    public class IFI_Bagfilter_Database_With_CanopyDto
    {
        ...
        public string? Bolt_CC_Distance_Configuration { get; set; }
        public string? Base_Plate_Dimension { get; set; }
