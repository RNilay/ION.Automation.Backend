namespace IonFiltra.BagFilters.Application.DTOs.Bagfilters.Sections.Roof_Door
{
    public class RoofDoorDto
    {
        ...
        public decimal? Stiffness_Factor_For_Roof_Door { get; set; }
