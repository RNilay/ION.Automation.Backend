    ...
    public static class ProcessInfoMapper
    {
        public static ProcessInfoMainDto ToMainDto(ProcessInfo entity)
        {
            ...
            return new ProcessInfoMainDto
            {
                ...
                ProcessInfo = new ProcessInfoDto
                {
                    ...
                    Transportation_Select = entity.Transportation_Select,
                    Transportation_Cost = entity.Transportation_Cost,
        ...
        public static ProcessInfo ToEntity(ProcessInfoMainDto dto)
        {
            ...
            return new ProcessInfo
            {
                ...
                Design_Pressure_Mmwc = dto.ProcessInfo.Design_Pressure_Mmwc,
                Mfg_Plant = dto.ProcessInfo.Mfg_Plant,
                Destination_State = dto.ProcessInfo.Destination_State,
                Location = dto.ProcessInfo.Location,
                Transportation_Select= dto.ProcessInfo.Transportation_Select,
                Transportation_Cost = dto.ProcessInfo.Transportation_Cost,
