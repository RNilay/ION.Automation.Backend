...
CREATE TABLE
    ...
    ionfiltrabagfilters.BagfilterInput (
        ...
        Total_Capsule_Height DECIMAL(10, 2),
        ...
        Stiffening_Factor_Roof_Door DECIMAL(10, 2),
...
CREATE TABLE
    ...
    ionfiltrabagfilters.CageInputs (
        ...
        Weight_Of_Cage_Wires DECIMAL(10, 2),
        Weight_Of_Cage_Rings DECIMAL(10, 2),
        Weight_Of_One_Cage DECIMAL(10, 2),
        Cage_Weight DECIMAL(10, 2),
        CreatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
        UpdatedAt DATETIME NULL ON UPDATE CURRENT_TIMESTAMP,
        FOREIGN KEY (EnquiryId) REFERENCES ionfiltrabagfilters.Enquiry(Id) ON DELETE CASCADE,
    ...
    ionfiltrabagfilters.AccessGroup (
        ...
        BagfilterMasterId INT NOT NULL,
        Access_Type TEXT,
        Total_Weight_Of_Cage_Ladder DECIMAL(10, 2),
        Mid_Landing_Pltform TEXT,
        Platform_Weight DECIMAL(10, 2),
        Staircase_Height DECIMAL(10, 2),
        Staircase_Weight DECIMAL(10, 2),
...
CREATE TABLE
  `IFI_Bagfilter_Database_Without_Canopy` (
    ...
    `Bolt_CC_Distance_Configuration_RCC` TEXT,
    `Bolt_CC_Distance_Configuration_Steel` TEXT,
  ...
  CREATE TABLE
    ionfiltrabagfilters.IFI_Bagfilter_Database_With_Canopy (
        ...
        Bolts_Sleeve_Size_mm TEXT,
        Bolts_Embedded_Length_mm DECIMAL(10, 2),
        Bolt_CC_Distance_Configuration TEXT,
        Base_Plate_Dimension TEXT,
        Weight_of_Base_Plate_kg DECIMAL(10, 2),
        Total_Weight_of_Structure_kg DECIMAL(10, 2),
        CreatedAt DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
        UpdatedAt DATETIME NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE ionfiltrabagfilters.CableTimerToJB (
    Id INT AUTO_INCREMENT PRIMARY KEY,
    Place VARCHAR(100),
    Make VARCHAR(50),
    CableType VARCHAR(255),
...
CREATE TABLE ionfiltrabagfilters.CableJBToInstruments (
    Id INT AUTO_INCREMENT PRIMARY KEY,
    Place VARCHAR(100),
    Make VARCHAR(50),
    CableType VARCHAR(255),
